...
export const workExperiencesCz: WorkExperienceModel[] = [
  {
    ...
    from: 'Květen 2020',
    description:
      'Většinu času pracuji na vývoji (analýza, implementace, automatické ' +
      'testy) frontendové části aplikace (Angular, Jest, Cypress), ale občas ' +
      'pomáhám i s vývojem na backendu (Spring, PostgreSQL).',
  },
  {
...
export const LOCATION_CZ = 'Praha, Česká republika';
